 ...
 */
public class SimplePrefixAdapter<T extends Indexable> extends IndexablePrefixAdapter<T> {
    private IndexableAdapter<T> mAdapter;

    public SimplePrefixAdapter(IndexableAdapter<T> adapter, String index, String indexTitle, List<T> datas) {
